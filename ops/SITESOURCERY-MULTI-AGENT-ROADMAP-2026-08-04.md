...
- [x] Implement atomic one-use credit reservation/application during Custom
  ...
  cross-project reuse.
- [x] Materialize an accepted Custom-build quote into one exact first-payment
...
H1J carries that exact accepted quote into a server-owned first-payment
invoice, applies the reserved `$200` credit, verifies one automatic-tax Stripe
